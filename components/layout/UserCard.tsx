...
export function UserCard({ user }: UserCardProps) {
  return (
    ...
    <div className="relative flex items-center justify-center gap-3 rounded-[14px] border-transparent p-0 transition-colors duration-200 desktop:justify-start desktop:border desktop:border-white/[.08] desktop:bg-white/[.05] desktop:p-[11px] desktop:hover:border-white/[.14]">
